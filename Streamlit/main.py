...
# 画像の読み込み
# Pillow で画像を読み込んでから、
# Streamlit の image メソッドを使用すると、画像を表示させることができます。
# use_column_width = True とすると、アプリのレイアウトに
# 合わせて画像サイズを自動的に調整することが可能です。
...
# サイドバーを作成し、そこでテキスト入力による値の動的変更
text = st.sidebar.text_input('あなたの好きなスポーツを教えて下さい。')
'あなたの好きなスポーツ：' , text

# サイドバーを作成し、そこでスライダーによる値の動的変更
condition = st.sidebar.slider('あなたの今の調子は？', 0, 100, 50)
'コンディション：' , condition


# expander メソッドを使用すると、プルダウン表示を設定することができます。
# expander
